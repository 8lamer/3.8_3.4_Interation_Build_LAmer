			...
			<div class="bg">
				...
				<center>
					...
					<div class= "w3-container w3-panel w3-padding-large" style="height:80%;width:80%; background-color:rgba(255, 255, 255, .2);">
						...
						<div class="w3-third">
							<a href="playlist_SongArtist.php"> <img src="images/query1.jpg" class="w3-button w3-round w3-hover-opacity-off"  alt="Query 1" height="170" style="width:310px"> </a>
						...
						<div class="w3-left">
							<p2>Songs sorted by Song and Artist - Query One</p2>
						</div>	
					</div>
