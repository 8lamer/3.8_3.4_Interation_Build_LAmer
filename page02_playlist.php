	...
	<body>
		...
		<div class="w3-orange container w3-image">
			...
			<a href="playlist_genre.php"> <img src="images/placeholder.jpg" class="w3-button w3-round w3-opacity w3-hover-opacity-off"  alt="sun" height="170" style="width:310px"> </a>
						...
						<div class="w3-third">
			<a href="playlistV1.php"> <img src="images/placeholder.jpg" class="w3-border w3-border-white w3-button w3-round w3-opacity w3-hover-opacity-off"  alt="Song A - Z" height="170" style="width:310px"> </a>
							<h3>SONG A - Z</h3>
						</div>
		...
		<a href="playlist_SongArtist.php"> <img src="images/placeholder.jpg" class="w3-button w3-round w3-opacity w3-hover-opacity-off"  alt="sun" height="170" style="width:310px"> </a>
						...
						<div class="overflowTest" >
							<content>
								...
								$query = ("SELECT s.Song_ID, s.Images, s.Title, s.Size, s.Seconds,
						...
						<div class="w3-left">
							<p2>Songs sorted by ID and Title</p2>
						</div>
